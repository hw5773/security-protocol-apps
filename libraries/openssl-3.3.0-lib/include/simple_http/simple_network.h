...
int open_tcp_connection(const char *domain, uint16_t port, int nonblock);
int open_tcp_listener(uint16_t port, int nonblock);

int open_udp_connection(const char *domain, uint16_t port, int nonblock);
int open_udp_listener(uint16_t port, int nonblock);
